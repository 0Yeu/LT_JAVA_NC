...
public class MyDialog extends JDialog {
        ...
        final ImageIcon iconError = new ImageIcon("src/images/icons8_cancel_70px.png");
        final ImageIcon iconSuccess = new ImageIcon("src/images/icons8_checkmark_70px.png");
        final ImageIcon iconInfo = new ImageIcon("src/images/icons8_info_70px.png");
        final ImageIcon iconWarning = new ImageIcon("src/images/icons8_warning_shield_70px.png");
        ...
        private void addControls() {
                ...
                lblClose = new JLabel(new ImageIcon("src/images/icons8_x_24px.png"));
